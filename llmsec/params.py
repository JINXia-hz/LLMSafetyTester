...
# 10. 采样器清单（r7 单源）
# ============================================================
# launch 表单 / TUI 表单 / 任务路由校验共用；增删采样器只改这里。
SAMPLERS = ("gap", "infogain", "coordinate", "hybrid")

# ============================================================
# 11. 预览截断长度（r9/P3-1 单源）
# ============================================================
# 三种语义角色三个常量；曾以裸魔法数散落 12 处，L-3 的 train/serve 词项偏移
# （训练= response_preview 截断、推理= 全文）正是这样长出来的。
# 关键耦合：prescreen 训练文本与 judge.evaluate 的预筛输入必须同为 PREVIEW_RESPONSE。
